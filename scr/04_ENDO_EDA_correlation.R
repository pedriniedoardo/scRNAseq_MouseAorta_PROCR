...
# GOI <- c("Procr","Il33","Sox9","Bst1","Cd200","Cd34","Pdgfra","Pecam1","Mcam","Eng","Cdh5","Etv2")
# Etv2 is almost not expressed
GOI <- c("Procr","Il33","Sox9","Bst1","Cd200","Cd34","Pdgfra","Pecam1","Mcam","Eng","Cdh5")
...
pdf("../../out/plot/ggpair_stemness_sc.pdf",width = 15,height = 15)
...
df_exp %>%
  ...
  theme_bw()
ggsave("../../out/plot/correlation_stemness_Procr.pdf",width = 4,height = 4)
...
exp_avg_wide <- df_exp_avg %>%
  select(group_id,gene,avg_exp) %>%
  pivot_wider(names_from = gene,values_from = avg_exp)

pdf("../../out/plot/ggpair_stemness_avg.pdf",width = 15,height = 15)
...
test_correlation2 <- cor(exp_avg_wide %>%
                         ...
                         method = "spearman")
# plot as heatmap
pdf("../../out/plot/correlation_stemness_spearman_matrix.pdf",width = 5,height = 4)
